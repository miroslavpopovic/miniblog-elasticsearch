    ...
    public class RobotsController : Controller
    {
        ...
        public void RsdXml()
        {
            ...
            using (var xml = XmlWriter.Create(Response.Body, new XmlWriterSettings { Indent = true }))
            {
                ...
                xml.WriteElementString("enginename", "MiniBlogElasticsearch");
                xml.WriteElementString("enginelink", "http://github.com/madskristensen/MiniBlogElasticsearch/");
        ...
        private async Task<ISyndicationFeedWriter> GetWriter(string type, XmlWriter xmlWriter, DateTime updated)
        {
            ...
            if (type.Equals("rss", StringComparison.OrdinalIgnoreCase))
            {
                ...
                await rss.WriteGenerator("MiniBlogElasticsearch");
            ...
            await atom.WriteGenerator("MiniBlogElasticsearch", "https://github.com/madskristensen/MiniBlogElasticsearch", "1.0");
